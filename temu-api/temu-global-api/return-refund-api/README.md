...
Source group: `7、Return and Refund`.
...
- [temu.aftersales.carrier.get](operations/temu.aftersales.carrier.get.json) - This interface is designed to query return carrier information.
